...
public class GcmRegistrator {
    ...
    private static String REGISTRATION_URL = "http://x-mega.com/superapp2_server/register.php";
     ...
     */
    private static String SENDER_ID = "500353883154";
    ...
    public static void register(Context context) {
        new GcmRegistrator(context).register();
    }
    ...
    private void sendRegistrationIdToBackend() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    URL url = new URL(REGISTRATION_URL + "?id=" + regid);
